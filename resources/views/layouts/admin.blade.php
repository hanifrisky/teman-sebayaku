...
<div class="flex min-h-screen">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-gradient-to-b from-blue-900 via-blue-800 to-blue-950 text-white transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out shadow-2xl">
        ...
        <nav class="mt-4 px-3 space-y-1">
            ...
            <a href="{{ route('admin.option-groups.index') }}" class="sidebar-item {{ request()->routeIs('admin.option-groups.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.interpretations.index') }}" class="sidebar-item {{ request()->routeIs('admin.interpretations.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.lessons.index') }}" class="sidebar-item {{ request()->routeIs('admin.lessons.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                Manajemen Lesson
            </a>
